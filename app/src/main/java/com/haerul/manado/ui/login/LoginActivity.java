package com.haerul.manado.ui.login;
...
import com.haerul.manado.utils.SQLiteDownloaderActivity;
...
public class LoginActivity extends BaseActivity<ActivityLoginBinding, LoginViewModel> implements LoginViewModel.LoginNavigator,
    ...
    private void loginProcess() {
        ...
        if (login()) {
            ...
            if (binding.checkbox.isChecked()) {
                ...
                Util.putPreference(LoginActivity.this, Constants.USER_LOGIN_NAME, binding.username.getText().toString());
            ...
            object.addProperty("lat_login", viewModel.lat);
            object.addProperty("lon_login", viewModel.lon);
        ...
        locationSetting.addOnFailureListener(this, e -> {
            if (e instanceof ResolvableApiException) {
                try {
                    ...
                    resolvable.startResolutionForResult(LoginActivity.this, REQUEST_CHECK_LOCATION);
    ...
    private void setLocationToText() {
        viewModel.lat = String.valueOf(location.getLatitude());
        viewModel.lon = String.valueOf(location.getLongitude());
